...
When('the high-level eslint-config scaffolder is executed', async function () {
  ...
  const javascriptQuestionNames = javascriptPromptConstants.questionNames.BASE_DETAILS;
  ...
  await extendEslintConfig({
    ...
    ...repoShouldBeCreated && {
      ...
      [githubPromptConstants.questionNames[githubPromptConstants.ids.REQUIRED_CHECK_BYPASS].ADMIN_BYPASS]: true
    },
