...
vi.mock('./scaffolder/sub-command.js');
vi.mock('./lift/sub-command.js');
vi.mock('./ski-patrol/sub-command.js');
vi.mock('./shuttle/sub-command.js');
vi.mock('./sno-cat/sub-command.js');
vi.mock('./add-package/sub-command.js');
